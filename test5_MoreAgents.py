...
configuration_map=cv2.imread('White.png')
...
Goalies=[[(20,20),(200,200)],[(200,20),(20,200)],[(20,200),(200,20)],[(200,200),(20,20)]]
...
#             break
for i in range(n):
    if bots[i].pos==Goalies[i][0]:
        bots[i].goal=Goalies[i][1]
    else:
        bots[i].goal=Goalies[i][0]
...
while True:
    ...
    for bot in bots:
        if bot.path==[]:
            ...
            if bots[bot.me].pos==Goalies[bot.me][0]:
                bots[bot.me].goal=Goalies[bot.me][1]
            else:
                bots[bot.me].goal=Goalies[bot.me][0]
           # pygame.draw.circle(screen,(255,255,0),bot.goal,5)
           # pygame.display.flip()
            # print("HAPpened")
      #      bot.path=["A"]
       ...
       #     pygame.display.flip()
         ...
         #   print(forc)
            magx=math.sqrt(forc[0]**2+forc[1]**2)*5
       #     print("MAGX",magx)
            updated_pos[bot.me]=(bot.pos[0]+forc[0]/magx*10,bot.pos[1]+forc[1]/magx*10)
